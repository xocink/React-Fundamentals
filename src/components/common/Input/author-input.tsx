...
//
// const AuthorInput = ({ secondAction, type } : ISearchInputProps) : JSX.Element => {
...
//
//   return (
// <input onChange={changeHandler} ref={authorInput}
// className="search-input" type="text" placeholder="enter..." />
//   );
// };
//
